...
export const AddEmployee = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (photoFile) {
        photoUrl = await uploadProfilePhoto(photoFile, tempId);
      }
            ...
            <div className="text-center">
              <div className="relative inline-block">
                {photoPreview ? (
                  ...
                  <div className="w-32 h-32 rounded-full bg-gradient-to-br from-blue-100 to-teal-100 flex items-center justify-center border-4 border-blue-100">
